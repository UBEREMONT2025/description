...
- Обязательные сущности МВП: Проект, Клиент, Дизайн‑этап, Акт, Договор,
  Платёж, Тендер, Отклик, Участник проекта.
...
- **Платёж** — финансовая операция, связанная с актом/этапом.
...
- Акт 1..N Платежей (или 1..1 в МВП).

**Вопросы для уточнения:**
1) Нужна ли отдельная сущность «Лид/Сделка» в доменной модели
   или достаточно описать это как статусы внутри Битрикс24?
2) Платёж в МВП всегда 1 к 1 с актом, или допускаем несколько оплат на акт?
