...
- Доступ файлов в WEB через БФФ (прокси/подписанные ссылки) — на уточнении
  с учетом офлайн‑доступа.
...
**Вопросы для уточнения:**
1) Нужен ли офлайн‑режим с предзагрузкой файлов проекта (PWA/кеш)?
2) Какие форматы файлов (PDF/DWG/изображения) и лимиты размера?
